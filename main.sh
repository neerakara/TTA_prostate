...
#$ -j y
#
# logging directory. preferably on your scratch (SET YOUR PATH HERE)
#$ -o /usr/bmicnas01/data-biwi-01/nkarani/projects/dg_seg/methods/tto_ss/logs/  ## <---------------- CHANGE TO MATCH YOUR SYSTEM
#
## send mail on job's end and abort
#$ -m a

# activate virtual environment  (SET YOUR PATH HERE)
source /usr/bmicnas01/data-biwi-01/nkarani/softwares/anaconda/installation_dir/bin/activate tf_v1_12

## EXECUTION OF PYTHON CODE: (SET YOUR PATH HERE)
python /usr/bmicnas01/data-biwi-01/nkarani/projects/dg_seg/methods/tto_ss/tmp/update_i2i_all.py
